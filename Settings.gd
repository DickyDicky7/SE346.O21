...
var score_file = "user://highscore.save"; var settings_file = "user://settings.save";
...
var color_schemes = {
	"NEON1": {
		'background'    : Color8(050, 050, 070),
		'player_body'   : Color8(203, 255, 000),
		'player_trail'  : Color8(204, 000, 255),
		'circle_fill'   : Color8(255, 000, 110), 
		'circle_static' : Color8(000, 255, 102),
		'circle_limited': Color8(204, 000, 255),
	},
	"NEON2": {
		'background'    : Color8(000, 000, 000),
		'player_body'   : Color8(246, 255, 000),
		'player_trail'  : Color8(255, 255, 255),
		'circle_fill'   : Color8(255, 000, 110),
		'circle_static' : Color8(151, 255, 048),
		'circle_limited': Color8(127, 000, 255),
	},
	"NEON3": {
		'background'    : Color8(076, 084, 095),
		'player_body'   : Color8(255, 000, 187),
		'player_trail'  : Color8(255, 148, 000),
		'circle_fill'   : Color8(255, 148, 000),
		'circle_static' : Color8(170, 255, 000),
		'circle_limited': Color8(204, 000, 255),
	}
};
